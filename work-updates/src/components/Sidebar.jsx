...
import { Home, FolderKanban, Users, CheckSquare, X, LogOut, CalendarClock, FileText, ChevronLeft } from 'lucide-react';
...
const Sidebar = ({ isOpen, onClose }) => {
    ...
    const isAdminOrTL = isSuperAdmin || isTeamLead || isDomainLead;
    ...
    const menu = [
        ...
        { label: 'Task History', path: '/task-history', icon: <CalendarClock className="h-5 w-5" />, hidden: isAdminOrTL },
